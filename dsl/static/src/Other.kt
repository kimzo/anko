...
[suppress("NOTHING_TO_INLINE")]
public inline fun ViewManager.include(layoutId: Int): LinearLayout = include(layoutId, {})
public inline fun ViewManager.include(layoutId: Int, inlineOptions(InlineOption.ONLY_LOCAL_RETURN) init: _LinearLayout.() -> Unit): LinearLayout = addView { ctx ->
    val view = _LinearLayout(ctx)
    view.setOrientation(LinearLayout.VERTICAL)
    view.init()
    view
...
[suppress("NOTHING_TO_INLINE")]
public inline fun Activity.include(layoutId: Int): LinearLayout = include(layoutId, {})
public inline fun Activity.include(layoutId: Int, inlineOptions(InlineOption.ONLY_LOCAL_RETURN) init: _LinearLayout.() -> Unit): LinearLayout = addView { ctx ->
    val view = _LinearLayout(ctx)
    view.setOrientation(LinearLayout.VERTICAL)
    view.init()
    view
...
[suppress("NOTHING_TO_INLINE")]
public inline fun Context.include(layoutId: Int): LinearLayout = include(layoutId, {})
public inline fun Context.include(layoutId: Int, inlineOptions(InlineOption.ONLY_LOCAL_RETURN) init: _LinearLayout.() -> Unit): LinearLayout = addView { ctx ->
    val view = _LinearLayout(ctx)
    view.setOrientation(LinearLayout.VERTICAL)
    view.init()
    view
